          ...
          <div className='max-w-4xl mx-auto text-center'>
            <div className='bg-[#1A1A1A] rounded-2xl border border-[#333333] p-12 shadow-2xl'>
              ...
              <p className='text-[#CCCCCC] text-lg mb-8'>
                Thank you for participating in the mayoral election. Your votes
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='text-center mb-12'>
            <h1 className='text-4xl font-bold text-white mb-4'>
              Mayoral <span className='text-[#9D5CFF]'>Election 2024</span>
            </h1>
...
export default MayoralElection;
