...
const Elections = () => {
  ...
  const getTypeBadge = (typeId) => {
    const typeMap = {
      1: { name: "Mayoral", color: "from-[#3B82F6] to-[#1D4ED8]" },
      2: { name: "Municipality", color: "from-[#F59E0B] to-[#D97706]" },
      3: { name: "Parliamentary", color: "from-[#10B981] to-[#059669]" },
      4: { name: "Speaker", color: "from-[#6C2BD9] to-[#9D5CFF]" },
    };
  ...
  const handleElectionAction = (election) => {
    ...
    if (now > endDate) {
      ...
      window.location.href = `/results/municipal/${election.id}`;
      return;
    }

    const electionType = Object.fromEntries(
      electionTypes.map((type) => [type.id, type.name]),
    );
  ...
  const handleSubmitCandidate = (election) => {
    // Navigate to submit-form/candidate with election ID
    window.location.href = `/submit-form/candidate?electionId=${election.id}`;
  };
    ...
    <>
      ...
      <main className="min-h-screen bg-[#0E0E0E] py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            <div className="flex flex-col gap-2">
                              ...
                              {/* Additional button for upcoming elections */}
                              {isUpcoming && !election.is_active && (
                                <button
                                  onClick={() =>
                                    handleSubmitCandidate(election)
                                  }
                                  className="px-4 py-2 rounded-lg font-medium transition-all duration-200 bg-gradient-to-r from-[#10B981] to-[#059669] hover:from-[#0EA271] hover:to-[#0A8F5E] text-white transform hover:scale-105 cursor-pointer"
                                >
                                  Submit Candidacy
                                </button>
                              )}

                              {/* Additional button for completed elections */}
                              {isCompleted && (
                                <button
                                  onClick={() => handleViewResults(election)}
                                  className="px-4 py-2 rounded-lg font-medium transition-all duration-200 bg-gradient-to-r from-[#F59E0B] to-[#D97706] hover:from-[#F6A91B] hover:to-[#E28616] text-white transform hover:scale-105 cursor-pointer"
                                >
                                  View Results
                                </button>
                              )}
          ...
          {/* Help Section - Updated to include new functionality */}
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#888888] text-sm">
                      For upcoming elections, you can submit your candidacy by
                      clicking "Submit Candidacy". This allows you to run as a
                      candidate.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#888888] text-sm">
                      Blue = Upcoming, Green = Active, Gray = Completed, Red =
                      Inactive. Different actions are available based on status.
                    </p>
                  </div>
                </div>
              </div>
